...
<div class="container-fluid" style="padding: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="index.php">GESCO</a>
      ...
      <ul class="navbar-nav">
        <li class="nav-item ">
          <a class="nav-link" href="index.php">Etudiants <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item" href="filieres.php">Filières</a>
          </div>
        </li>
      </ul>
      </div>
